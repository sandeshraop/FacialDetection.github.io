#!/usr/bin/env python3
"""
CORRECTED Real-time Micro-Expression Recognition with ROI Attention
...
class RealTimeMicroExpressionRecognizer:
    def __init__(self, model_path=None):
        ...
        # Initialize buffers (CORRECTED)
        self.prev_rois = None  # Store previous ROI images
    ...
    def extract_roi_from_frame(self, frame, landmarks):
        ...
        try:
            ...
            # ✅ CRITICAL FIX: Use landmarks.landmark (iterable list)
            for roi_name in self.roi_names:
                roi_flow, _ = self.flow_computer.extract_roi_from_landmarks(
                    frame, landmarks.landmark, roi_name  # ✅ FIXED: landmarks.landmark
                )
    ...
    def compute_optical_flow_between_rois(self, prev_rois, curr_rois):
        """Compute optical flow between ROI images (CORRECTED)"""
        try:
            flow_data = {}
            for roi_name in self.roi_names:
    ...
    def run(self):
        """CORRECTED Main real-time recognition loop"""
        print("🎥 Starting CORRECTED Real-time Micro-Expression Recognition")
        print("Press 'q' to quit, 's' to save current frame")
        print("✅ Fixed: ROI-to-ROI flow computation")
        print("✅ Fixed: Frame skipping for performance")
        ...
        while True:
            ...
            if results.multi_face_landmarks:
                ...
                # 5. Update previous ROIs (CRRECTED)
        ...
        print("🎉 CORRECTED Real-time recognition stopped")
